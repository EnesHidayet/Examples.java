...
//        ismeGoreSehirBul("Ankarax",app.list).ifPresentOrElse(x-> System.out.println(x),()-> System.out.println("Sehir Bulunamadı"));
    ...
    public static Set<String> plakaKodlariniListedeTopla(List<Sehir> sehirler){
    ...
    public static   Map<String, String>   plakaKodunaKarsilikSehirIsmi(List<Sehir> sehiler){
