package org.enes.lesson28.sehirApp;
...
public class App2 {
   ...
   SehirManager sehirManager;
    ...
    public ArrayList<Sehir> nufusaGoreSirala(ArrayList<Sehir> liste){
...
//        Collections.sort(stringList);
    ...
    /// a dan zye
    public ArrayList<Sehir> ismeGoreAdanZyeSirala(ArrayList<Sehir> liste){
...
//        };
    ...
    public ArrayList<Sehir> ismeGoreZdenAyaSirala(ArrayList<Sehir> liste){
//        Comparator<Sehir> comparator= new Comparator<Sehir>() {
//            @Override
//            public int compare(Sehir sehir1, Sehir sehir2) {
...
//  Collections.shuffle(app.list);
        ArrayList<Sehir>  sehirler5= app.bolgeyeGoreSiralama(app.list);
        sehirler5.forEach(System.out::println);
    }

    private ArrayList<Sehir> plakaKodunaGoreSirala(ArrayList<Sehir> liste) {
        Comparator<Sehir> comparator=new Comparator<Sehir>() {
            @Override
            public int compare(Sehir o1, Sehir o2) {
    ...
    private ArrayList<Sehir> bolgeyeGoreSiralama(ArrayList<Sehir> liste) {
        Comparator<Sehir> comparator=new Comparator<Sehir>() {
            @Override
            public int compare(Sehir o1, Sehir o2) {
