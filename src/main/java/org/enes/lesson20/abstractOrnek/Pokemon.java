...
/**
 Abstract classlardan nesne üretilmez. new leme yapýlmaz.
 abstract classlarda gövdeli metotlar yazýlabilir.
 abstract classlarda gövdesiz abstract metotlar yazýlabilir.
 */
...
//        this.id= new Random().nextInt(0,100);
    ...
    //gövdesiz metotlar alt sýnýflarda özelleþebilecek metotlardýr.
    public abstract void ozelSadldiriYap();
    //gövdeli metotlar ise bütün alt sýnýflar için ayný iþlemi yapan metotlardýr.
    public void saldir(){
